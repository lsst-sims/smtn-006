...
View this technote at http://smtn-006.lsst.io or see a preview of the
...
.. code-block:: bash
   ...
   git clone https://github.com/lsst-sims/smtn-006
   cd smtn-006
...
The published technote at http://smtn-006.lsst.io will be automatically rebuilt whenever you push your changes to the ``master`` branch on `GitHub <https://github.com/lsst-sims/smtn-006>`_.
